...
#group by state, calculate mean SO2, mean NO3 over past 10 years
...
* Based on the plot above, we observe that OH, IN, PA, KY, and VA have the top 5 mean SO2 amount, IN, IL, OH, NY, KY have top 5 mean NO3 amount during past 10 years.
* According to EPA, the main source of SO2 and NO3 is the burning of fossil fuels by power plants and other industrial facilities. For fossil fules example, SO2 and NO3 concentration has a positive correlation with coal and petroleum consumption. According to Primary Energy Consumption Estimates by Source, Ranked by State, 2018(https://www.eia.gov/state/seds/data.php?incfile=/state/seds/sep_sum/html/rank_use_source.html&sid=US), we noticed that TX, IN, OH have highest coal consumption, KY and PA rank 7&8 in coal consumption. Also for petroleum consumption, LA, NY, IL, PA, OH rank 3,5,6,7,and 8. These contribute to high SO2 and NO3 emmsion in IN, OH, PA, IL, NY and KY. 
* Moreover we found that states with highest SO2 and NO3 amount neighbor each other, it could be affected by the transport of SO2/NO3 within air shed affected by climate. Emissions of SO2/NO3 from OH and IN could travel to the East Coast, driving up the amount of air pollution in states such as PA, KY and VA.
* Promoting cleaner energy can make to positive difference to air pollution because coal consumption is crucial reason of SO2 and NO3 emission.
...
* This stack bar chart shows the overall distribution of the main pollutants, SO2 and NO3. We noticed that states with higher SO2 tend to have higher NO3 emission, but also some states with higher SO2 while have lower NO3 emission. This could be affected by different combination of fossial fules using and factorial emission. Besides energy source like coal and petroleum, factories and other industrial installations have caused such pollution with metal smelting, petrochemical smog and food precessing. For example, heating and smelting metal processes produce emissions of sulfur oxides. 
*  Air pollution can also be controlled by strengthen emission regulation through the installation of filters and scrubbers to clean exhaust fumes from factory processes, and by taking steps to minimize the generation of pollution at the source.

##Combine two datasets
Since cancer data are from year 2013-2017, we use the mean of the amount of SO2 and NO3 from 2013-2017 as the indicator.
```{r}
